...
import { Breadcrumb, Layout, Menu, Upload, Button, Form, Input, Select } from 'antd';
  ...
  render() {
    return (
      <div className="site-layout-background" style={{
        ...
        <Form onFinish={this.handleFormSubmit} style={{ width: '400px' }}>
          <Form.Item name="question" label="Qeustion">
